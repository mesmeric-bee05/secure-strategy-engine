...
export const Route = createRootRouteWithContext<RouterContext>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "AI skills mapping, automation-risk intelligence, opportunity matching, and cryptographic credentials for informal-economy workers." },
